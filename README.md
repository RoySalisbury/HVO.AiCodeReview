...
| [Testing](docs/testing.md) | Disposable test repositories, 6-layer safety system, test categories (473 tests), test infrastructure, running tests, manual utilities, test configuration, test roadmap. |
