...
All badges above are **dynamic** — updated automatically by CI on every push to `main`.
...
For full details — test categories, coverage targets, infrastructure, configuration, and roadmap — see [Testing](docs/testing.md).
